...
**Note that this code has not yet completed a security review and therefore we strongly recommend that you do not use it in production. We take no responsibility for any loss you may incur through the use of this code.**

**We hope that this transpiler allows you to quickly generate draft frameworks for zApps. Due to its experimental nature, we strongly recommend that you do not deploy any zApps which are generated by this transpiler. All output zApps should undergo a full security review. We take no responsibility for any loss you may incur through the use of any output zApp code.**

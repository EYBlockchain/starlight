...
export class RemoveManager {
	...
	async remove(
		...
		const a_nullifierRoot = generalise(
			a_0_nullifier_NonMembership_witness.root
		);
			...
			.remove(
				{
					...
					newNullifiers: [a_0_nullifier.integer, a_1_nullifier.integer],
					commitmentRoot: a_root.integer,
					newCommitments: [a_2_newCommitment.integer],
					cipherText: [],
					encKeys: [],
				},
				proof,

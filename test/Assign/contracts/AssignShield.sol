...
contract AssignShield is MerkleTree {
      ...
      function add (Inputs calldata inputs, uint256[] calldata proof, BackupDataElement[] memory BackupData) public  {
      ...
      function remove (Inputs calldata inputs, uint256[] calldata proof, BackupDataElement[] memory BackupData) public  {

    ...
    FunctionDefinition: {
        ...
        exit(path, state) {
            ...
            if ((functionIndicator.newCommitmentsRequired ||
                ...
                for (const [id, stateVarIndicator] of Object.entries(functionIndicator)) {
    ...
    Identifier: {
        enter(path, state) {
            ...
            if (state.interactsWithSecret && // we only need to import something if it interactsWithSecret
                ...
                ((_a = indicator.binding) === null || _a === void 0 ? void 0 : _a.stateVariable) && // we can't import local variables
                ((indicator.isSecret && !indicator.isModified) || !indicator.isSecret) // we already deal with secret modified states
            ) {
                (_b = (_c = fnDefNode.node._newASTPointer.parameters).importedStateVariables) !== null && _b !== void 0 ? _b : (_c.importedStateVariables = []);

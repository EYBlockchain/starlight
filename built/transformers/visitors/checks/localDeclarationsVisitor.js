    ...
    'VariableDeclarationStatement|VariableDeclaration': {
        enter(path, state) {
            ...
            if (path.getAncestorContainedWithin('body') && !warningThrown) {
                warningThrown = true;
                logger.warn("Local state declarations aren't fully supported yet, because their possible interactions with private states complicate things considerably. If the local state you've declared interacts with a secret variable, transpilation might result in bugs at the moment. We're actively working on it.");
            }
        },
    },
};

...
export default function buildNode(nodeType, fields = {}) {
    switch (nodeType) {
        ...
        case 'FunctionDefinition': {
            // prettier-ignore
            const { name, body = buildNode('Block'), parameters = buildNode('ParameterList'), contractName } = fields;
            return {
                nodeType,
                name,
                contractName,
        ...
        case 'ExpressionStatement': {
            const { expression = {}, interactsWithSecret, incrementsSecretState, decrementsSecretState, privateStateName, } = fields;
            return {
                nodeType,
                expression,
                interactsWithSecret,

...
class FunctionBoilerplateGenerator {
    constructor() {
        ...
        this.customFunction = {
            parameters({ nullifiersRequired: newNullifiers, oldCommitmentAccessRequired: commitmentRoot, newCommitmentRequired: newCommitments, containsAccessedOnlyState: checkNullifiers, }) {
                return [
            ...
            nullifiersRequired: newNullifiers, oldCommitmentAccessRequired: commitmentRoot, newCommitmentRequired: newCommitments, containsAccessedOnlyState: checkNullifiers, }) {
                // prettier-ignore
                return [
                    `

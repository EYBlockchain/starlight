...
export default function buildBoilerplate(nodeType, fields = {}) {
    const { stateName, contractName, stateVarIds = [], parameters = [], // used for extra params in generateProof
    newOwnerStatment, increment, mappingKey, mappingName, reinitialisedOnly = false, burnedOnly = false, accessedOnly = false, onChainKeyRegistry = `false`, } = fields;
    switch (nodeType) {
        case 'Imports':
            // once per function
            return [

      ...
      if (
        ...
        for (stateVarIndicator of allIndicators) {
          ...
          if (stateVarIndicator instanceof MappingKey) {
            ...
            id = [id, scope.getMappingKeyName(stateVarIndicator.keyPath.node) || ``, stateVarIndicator.keyPath.node.isNestedMapping ? stateVarIndicator.keyPath.node.indexExpression.name : stateVarIndicator.keyPath.node.name];
            name = (accessedOnly ?

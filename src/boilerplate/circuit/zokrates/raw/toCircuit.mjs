export const EditableCommitmentImportStatementsBoilerplate = [
...
export const editableCommitmentParametersBoilerplate = privateStateName => {
  const x = privateStateName;
  return [
    `private u32[8] ${x}_oldCommitment_privateState`,
    ...
    `private u32[8] ${x}_newCommitment_privateState`,

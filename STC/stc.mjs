...
function transformer(ast) {
  ...
  traverser(ast, {
    ...
    NumberLiteral: {
      ...
      enter(node, parent) {
        logger.debug('\n\n\n\n*************************************************');
        logger.debug('NumberLiteral before enter');
        ...
        logger.debug('\n\n\n\nNumberLiteral after enter');
        logger.debug('node:', node);
        logger.debug('parent:', parent);
        logger.debug('*************************************************');
      },
      exit(node, parent) {
        logger.debug('\n\n\n\nNumberLiteral at exit');
        logger.debug('node:', node);
        logger.debug('parent:', parent);
      },
    },
    ...
    StringLiteral: {
      enter(node, parent) {
        logger.debug('\n\n\n\n*************************************************');
        logger.debug('StringLiteral before enter');
        logger.debug('node:', node);
        logger.debug('parent:', parent);
        ...
        logger.debug('\n\n\n\nStringLiteral after enter');
        logger.debug('node:', node);
        logger.debug('parent:', parent);
        logger.debug('*************************************************');
      },
      exit(node, parent) {
        logger.debug('\n\n\n\nStringLiteral at exit');
        logger.debug('node:', node);
        logger.debug('parent:', parent);
      },
    },
    ...
    CallExpression: {
      enter(node, parent) {
        logger.debug('\n\n\n\n*************************************************');
        logger.debug('CallExpression before enter');
        logger.debug('node:', node);
        logger.debug('parent:', parent);
        ...
        logger.debug('\n\n\n\nCallExpression after enter');
        logger.debug('node:', node);
        logger.debug('parent:', parent);
        logger.debug('*************************************************');
      },
      exit(node, parent) {
        logger.debug('\n\n\n\nCallExpression at exit');
        logger.debug('node:', node);
        logger.debug('parent:', parent);
      },
    },

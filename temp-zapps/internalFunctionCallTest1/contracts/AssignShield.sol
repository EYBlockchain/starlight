...
contract AssignShield is MerkleTree {
          ...
          enum FunctionNames { addB, addA, remove, joinCommitments }
      ...
      function addB (uint256 value, uint256 value1, uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
...
inputs.customInputs[1] = 1;
          ...
          bytes4 sig = bytes4(keccak256("addB(uint256,uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)
      ...
      function addA (uint256 value, uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
...
inputs.customInputs[1] = 1;
          ...
          bytes4 sig = bytes4(keccak256("addA(uint256,uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)
      ...
      function remove (uint256 value, uint256 value1, uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

        
	 	 	 	 addB (value,value1,newNullifiers,commitmentRoot,newCommitments,proof);
	 	 	 	 addA (value1,newNullifiers,commitmentRoot,newCommitments,proof);
...
inputs.customInputs[2] = 1;
          ...
          bytes4 sig = bytes4(keccak256("remove(uint256,uint256,uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)

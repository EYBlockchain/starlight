...
contract OwnerShield is MerkleTree {
          ...
          enum FunctionNames { cnstrctr, alpha, beta }
...
inputs.customInputs[1] = 1;
      ...
      function beta (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata checkNullifiers, uint256[] calldata proof) public  {
...
inputs.customInputs[1] = 1;
          ...
          bytes4 sig = bytes4(keccak256("beta(uint256[],uint256,uint256[],uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)

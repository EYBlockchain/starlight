...
export default async function setb(_x, _b_newOwnerPublicKey = 0) {
	...
	let b = generalise(parseInt(x.integer, 10));
	...
	const res = await generateProof("setb", allInputs);

...
export default async function decrement(
	...
	const a_msgSender_0_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		a_msgSender_0_nullifier
	);
	const a_msgSender_1_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		a_msgSender_1_nullifier
	);
	...
	const a_msgSender_0_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		a_msgSender_0_nullifier
	);
	const a_msgSender_1_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		a_msgSender_1_nullifier
	);

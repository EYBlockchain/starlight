...
contract MyContractShield is MerkleTree {
          ...
          enum FunctionNames { increment, decrement, joinCommitments }
...
admin = msg.sender;
      ...
      function increment (uint256[] calldata newCommitments, uint256[] calldata proof) public  {
          ...
          bytes4 sig = bytes4(keccak256("increment(uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)
      ...
      function decrement (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
        ...
        require(msg.sender == admin);
          ...
          bytes4 sig = bytes4(keccak256("decrement(uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)

...
contract FakeBankShield is MerkleTree {


          enum FunctionNames { deposit, transfer }
      ...
      function deposit (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
          ...
          bytes4 sig = bytes4(keccak256("deposit(uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)
      ...
      function transfer (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

        
	 	 	 	 deposit (newNullifiers,commitmentRoot,newCommitments,proof);
          ...
          bytes4 sig = bytes4(keccak256("transfer(uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)

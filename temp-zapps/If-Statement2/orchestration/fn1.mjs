...
export default async function fn1(
	...
	const x_msgSender_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		x_msgSender_nullifier
	);
	...
	const x_msgSender_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		x_msgSender_nullifier
	);
	...
	const res = await generateProof("fn1", allInputs);

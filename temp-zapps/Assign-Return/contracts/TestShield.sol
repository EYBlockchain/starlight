...
contract TestShield is MerkleTree {
      ...
      function add (uint256 y, uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
...
inputs.customInputs[1] = 1;
          ...
          bytes4 sig = bytes4(keccak256("add(uint,uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)

...
contract AssignShield is MerkleTree {
          ...
          enum FunctionNames { add, remove, joinCommitments, splitCommitments }
      ...
      function add (uint256 value, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
      ...
      function remove (uint256 value1, uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

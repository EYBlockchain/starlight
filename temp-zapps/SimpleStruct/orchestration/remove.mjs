...
export default async function remove(
	...
	a = generalise(parseInt(a.integer, 10) + parseInt(value.prop1.integer, 10));
	...
	b = generalise(parseInt(b.integer, 10) + parseInt(value.prop1.integer, 10));
	...
	const txData = await instance.methods.remove().encodeABI();

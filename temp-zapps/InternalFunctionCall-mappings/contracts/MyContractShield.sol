...
contract MyContractShield is MerkleTree {
          ...
          enum FunctionNames { incr, decr, joinCommitments }
      ...
      function incr (uint256[] calldata newCommitments, uint256[] calldata proof) public  {
          ...
          inputs.customInputs = new uint[](1);
        	inputs.customInputs[0] = newCommitments[0];
      ...
      function decr (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
          ...
          bytes4 sig = bytes4(keccak256("decr(,uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)

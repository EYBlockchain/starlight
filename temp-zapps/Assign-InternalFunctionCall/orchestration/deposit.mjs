...
export default async function deposit(
	...
	const account_accountId_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		account_accountId_nullifier
	);
	...
	const account_accountId_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		account_accountId_nullifier
	);

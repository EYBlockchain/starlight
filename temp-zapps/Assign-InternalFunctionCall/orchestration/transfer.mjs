...
export default async function transfer(
	...
	const account_fromAccountId_currentCommitment =
	...
	const account_toAccountId_currentCommitment =
	...
	const account_toAccountId_path = generalise(
		account_toAccountId_witness.path
	).all;
	...
	const account_fromAccountId_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(account_fromAccountId_nullifier);
	...
	// Non-membership witness for Nullifier
	const account_toAccountId_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(account_toAccountId_nullifier);
	...
	const account_fromAccountId_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(account_fromAccountId_nullifier);
	...
	// Get the new updated nullifier Paths
	const account_toAccountId_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(account_toAccountId_nullifier);

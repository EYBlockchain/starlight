...
const FakeBankShield = artifacts.require("FakeBankShield");
const functionNames = ["deposit", "transfer"];
const vkInput = [];
let vk = [];
...
module.exports = (deployer) => {
	deployer.then(async () => {
		...
		await deployer.deploy(FakeBankShield, Verifier.address, vkInput);
	});
};

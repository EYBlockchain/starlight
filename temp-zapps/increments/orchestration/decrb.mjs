...
export default async function decrb(
	...
	const b_ky_0_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		b_ky_0_nullifier
	);
	const b_ky_1_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		b_ky_1_nullifier
	);
	...
	const b_ky_0_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		b_ky_0_nullifier
	);
	const b_ky_1_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		b_ky_1_nullifier
	);

...
export default async function incra(_param3, _a_newOwnerPublicKey = 0) {
	...
	const a_newCommitmentValue = generalise(parseInt(param3.integer, 10));
	...
	const res = await generateProof("incra", allInputs);
	...
	const txData = await instance.methods
		.incra([a_newCommitment.integer], proof)
		.encodeABI();

...
contract MyContractShield is MerkleTree {
          ...
          enum FunctionNames { assign, decra, decrb, incra, joinCommitments, splitCommitments }
      ...
      function assign (uint256 ky, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

        
          Inputs memory inputs;

          inputs.customInputs = new uint[](2);
        	inputs.customInputs[0] = ky;
inputs.customInputs[1] = 1;
      ...
      function decra (uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
      ...
      function decrb (uint256 ky, uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

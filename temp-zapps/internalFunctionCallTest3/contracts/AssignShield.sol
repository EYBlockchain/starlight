...
contract AssignShield is MerkleTree {
          ...
          enum FunctionNames { addB, addA, doubleAndAddBA }
      ...
      function doubleAndAddBA (uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

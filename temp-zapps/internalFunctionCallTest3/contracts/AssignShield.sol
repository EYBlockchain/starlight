...
contract AssignShield is MerkleTree {
      ...
      function addB (uint256 value, uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

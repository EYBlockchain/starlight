...
contract MyContractShield is MerkleTree {
          ...
          enum FunctionNames { assign, decr }
      ...
      function assign (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
          ...
          bytes4 sig = bytes4(keccak256("assign(uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)

...
export default async function add(
	...
	const cmt_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(cmt_nullifier);
	...
	const cmt_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(cmt_nullifier);

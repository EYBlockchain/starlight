...
export default async function remove(
	...
	// Non-membership witness for Nullifier
	const cmt_0_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		cmt_0_nullifier
	);
	const cmt_1_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		cmt_1_nullifier
	);
	...
	// Get the new updated nullifier Paths
	const cmt_0_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		cmt_0_nullifier
	);
	const cmt_1_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		cmt_1_nullifier
	);

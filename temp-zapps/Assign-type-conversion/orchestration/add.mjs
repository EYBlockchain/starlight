...
export default async function add(_addval, _a_newOwnerPublicKey = 0) {
	...
	const msgValue = 0;
	const addval = generalise(_addval);
	...
	a = generalise(parseInt(a.integer, 10) + parseInt(addval.integer, 10));

...
export default async function add(
	...
	// Non-membership witness for Nullifier
	const b_index_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(b_index_nullifier);
	...
	// Get the new updated nullifier Paths
	const b_index_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(b_index_nullifier);

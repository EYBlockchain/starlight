...
export default async function add(
	...
	const value2 = generalise(_value2);
	...
	a = generalise(parseInt(a.integer, 10) + parseInt(value1.integer, 10));

	a = generalise(a);

	let b = generalise(b_preimage.value);
	b = generalise(parseInt(b.integer, 10) + parseInt(value2.integer, 10));

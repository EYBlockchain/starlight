        ...
        function verify(
          ...
          if (newCommitments.length > 0) {
      			...
      			commitmentRoots[latestRoot] = latestRoot;
 	 	 	 	...
 	 	 	 	event eventFunction(uint256 id);


      function deposit (uint256 fid, uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public payable {

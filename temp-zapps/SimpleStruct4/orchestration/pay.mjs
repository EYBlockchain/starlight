...
export default async function pay(
	...
	const POs_id_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(POs_id_nullifier);
	...
	// Non-membership witness for Nullifier
	const invoices_id_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(invoices_id_nullifier);
	...
	const invoices_id_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(invoices_id_nullifier);

...
export default async function addInvoice(
	...
	const POs_invdotid_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(POs_invdotid_nullifier);
	...
	// Non-membership witness for Nullifier
	const invoices_invdotid_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(invoices_invdotid_nullifier);
	...
	const invoices_invdotid_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(invoices_invdotid_nullifier);

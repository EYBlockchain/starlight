...
export default async function addPO(
	...
	const POs_newpodotid_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(POs_newpodotid_nullifier);
	...
	const POs_newpodotid_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(POs_newpodotid_nullifier);

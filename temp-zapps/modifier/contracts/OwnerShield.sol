...
contract OwnerShield is MerkleTree {
          ...
          enum FunctionNames { cnstrctr, alpha, beta, gamma }
        ...
        function verify(
          ...
          if (functionId == uint(FunctionNames.beta)) {
            uint k = 0;
          ...
          if (functionId == uint(FunctionNames.gamma)) {
            uint k = 0;
...
inputs.customInputs[1] = 1;
      ...
      function alpha (uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
...
inputs.customInputs[1] = 1;
      ...
      function beta (uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
...
inputs.customInputs[1] = 1;
        ...
        inputs.latestNullifierRoot = latestNullifierRoot; 
          ...
          inputs.newCommitments = newCommitments;
           ...
           verify(proof, uint(FunctionNames.beta), inputs);
      ...
      function gamma (uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
        ...
        inputs.latestNullifierRoot = latestNullifierRoot; 
          ...
          inputs.newCommitments = newCommitments;
           ...
           verify(proof, uint(FunctionNames.gamma), inputs);

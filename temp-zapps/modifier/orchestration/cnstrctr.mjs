...
export default async function cnstrctr(
	...
	// Non-membership witness for Nullifier
	const adminstartor_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		adminstartor_nullifier
	);
	...
	// Get the new updated nullifier Paths
	const adminstartor_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		adminstartor_nullifier
	);

...
contract AssignShield is MerkleTree {
      ...
      function add (bool value_publicbool, uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

        
          Inputs memory inputs;

          inputs.customInputs = new uint[](2);
        	inputs.customInputs[0] = value_publicbool == false ? 0 : 1;
inputs.customInputs[1] = d == false ? 0 : 1;

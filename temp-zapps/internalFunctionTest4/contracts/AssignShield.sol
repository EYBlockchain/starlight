...
contract AssignShield is MerkleTree {
      ...
      function addB (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
          ...
          bytes4 sig = bytes4(keccak256("addB(uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)
      ...
      function remove (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
        	 	 	 	 ...
        	 	 	 	 addB (newNullifiers,commitmentRoot,newCommitments,proof);

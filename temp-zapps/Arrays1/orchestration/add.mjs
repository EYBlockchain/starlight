...
export default async function add(
	...
	index_3 = generalise(parseInt(index.integer, 10) + 1);
	...
	let b_index_1 = generalise(parseInt(index_1.integer, 10));

	b_index_1 = generalise(b_index_1);

	let a = generalise(a_preimage.value);
	a = generalise(parseInt(a.integer, 10) + parseInt(index_2.integer, 10));

	a = generalise(a);

	let b_index_3 = generalise(parseInt(value.integer, 10));

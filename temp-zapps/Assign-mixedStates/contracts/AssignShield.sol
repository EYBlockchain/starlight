...
contract AssignShield is MerkleTree {
          ...
          enum FunctionNames { add, remove, remove1, joinCommitments, splitCommitments }
      ...
      function remove1 (uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

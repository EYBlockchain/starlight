...
export default async function assign2(
	...
	a_msg_newOwnerPublicKey =
		_a_msg_newOwnerPublicKey === 0 ? publicKey : a_msg_newOwnerPublicKey;
	...
	b = parseInt(b.integer, 10) + parseInt(param3.integer, 10);
	...
	const tx = await instance.methods
		.assign2(
			[b_nullifier.integer],
			b_root.integer,
			[a_msg_newCommitment.integer, b_newCommitment.integer],
			proof
		)
		.send({

...
contract MyContractShield is MerkleTree {
          ...
          enum FunctionNames { assignA, assignBZ }
...
inputs.customInputs[2] = 1;
      ...
      function assignBZ (uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

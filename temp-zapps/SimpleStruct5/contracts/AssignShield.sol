...
struct MyStruct {
      ...
      function add (MyStruct memory struct_value_pub, uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {

        
          Inputs memory inputs;

          inputs.customInputs = new uint[](3);
        	inputs.customInputs[0] = struct_value_pub.prop1;
inputs.customInputs[1] = struct_value_pub.prop2 == false ? 0 : 1;

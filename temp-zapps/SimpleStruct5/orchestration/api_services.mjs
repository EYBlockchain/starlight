...
export async function service_add(req, res, next) {
	try {
		...
		const struct_value = {
			prop1: req.body.struct_value.prop1,
			prop2: req.body.struct_value.prop2,
		};
		const struct_value_pub = {
			prop1: req.body.struct_value_pub.prop1,
			prop2: req.body.struct_value_pub.prop2,
		};

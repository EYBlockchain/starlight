...
export default async function add(
	...
	const total_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(total_nullifier);
	...
	// Non-membership witness for Nullifier
	const structs_msgSender_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(structs_msgSender_nullifier);
	...
	const total_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(total_nullifier);
	...
	// Get the new updated nullifier Paths
	const structs_msgSender_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(structs_msgSender_nullifier);

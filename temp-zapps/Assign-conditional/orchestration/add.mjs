...
export default async function add(
	...
	const result_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		result_nullifier
	);
	...
	const result_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		result_nullifier
	);

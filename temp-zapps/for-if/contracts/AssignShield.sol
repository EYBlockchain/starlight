...
contract AssignShield is MerkleTree {
          ...
          enum FunctionNames { addB, addA, remove, addfn, joinCommitments }
      ...
      function addfn (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
          ...
          bytes4 sig = bytes4(keccak256("addfn(uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)

...
import { service_fncall } from "./api_services.mjs";

import { service_remove1 } from "./api_services.mjs";

import { service_remove2 } from "./api_services.mjs";
...
// eslint-disable-next-line func-names
router.post("/fncall", service_fncall);

// eslint-disable-next-line func-names
router.post("/remove1", service_remove1);

// eslint-disable-next-line func-names
router.post("/remove2", service_remove2);

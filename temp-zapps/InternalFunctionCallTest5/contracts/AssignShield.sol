...
contract AssignShield is MerkleTree {
          ...
          enum FunctionNames { addB, addA, fncall, remove1, remove2 }
        ...
        function verify(
          ...
          if (functionId == uint(FunctionNames.fncall)) {
            uint k = 0;
...
inputs.customInputs[1] = 1;
      ...
      function fncall (uint256 value, uint256 value1, uint256 nullifierRoot, uint256 latestNullifierRoot,uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
...
inputs.customInputs[2] = 1;
        ...
        inputs.latestNullifierRoot = latestNullifierRoot; 
          ...
          inputs.newCommitments = newCommitments;
           ...
           verify(proof, uint(FunctionNames.fncall), inputs);

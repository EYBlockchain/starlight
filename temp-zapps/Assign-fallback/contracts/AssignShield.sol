...
contract AssignShield is MerkleTree {
          ...
          enum FunctionNames { add, remove, remove1, joinCommitments }
      ...
      function remove1 (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
          ...
          bytes4 sig = bytes4(keccak256("remove1(uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)

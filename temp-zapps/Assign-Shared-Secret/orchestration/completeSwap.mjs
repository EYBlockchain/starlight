...
export default async function completeSwap(
	...
	const tokenOwners_tokenIdRecieved_commitment =
		await getCurrentWholeCommitment(tokenOwners_tokenIdRecieved_stateVarId);
	...
	const tokenOwners_tokenIdRecieved_currentCommitment =
	...
	const tokenOwners_tokenIdRecieved_witness =
		tokenOwners_tokenIdRecieved_witnessRequired
			? await getMembershipWitness(
					"SwapShield",
	...
	let tokenOwners_tokenIdRecieved_nullifier =
		tokenOwners_tokenIdRecieved_commitmentExists
			? poseidonHash([
	...
	// Non-membership witness for Nullifier
	const tokenOwners_tokenIdRecieved_nullifier_NonMembership_witness =
		getnullifierMembershipWitness(tokenOwners_tokenIdRecieved_nullifier);
	...
	// Get the new updated nullifier Paths
	const tokenOwners_tokenIdRecieved_updated_nullifier_NonMembership_witness =
		getupdatedNullifierPaths(tokenOwners_tokenIdRecieved_nullifier);

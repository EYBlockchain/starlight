...
contract MyContractShield is MerkleTree {
          ...
          enum FunctionNames { cnstrctr, setAdmin, assign }
...
inputs.customInputs[1] = 1;
      ...
      function setAdmin (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata proof) public  {
...
inputs.customInputs[1] = 1;
          ...
          bytes4 sig = bytes4(keccak256("setAdmin(uint256[],uint256,uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)
      ...
      function assign (uint256[] calldata newNullifiers, uint256 commitmentRoot, uint256[] calldata newCommitments, uint256[] calldata checkNullifiers, uint256[] calldata proof) public  {
...
inputs.customInputs[1] = 1;
          ...
          bytes4 sig = bytes4(keccak256("assign(uint256[],uint256,uint256[],uint256[],uint256[])")) ;  
 	 	 	 if (sig == msg.sig)

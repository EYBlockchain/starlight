...
export default async function decrement(
	...
	const a_addr_0_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		a_addr_0_nullifier
	);
	const a_addr_1_nullifier_NonMembership_witness = getnullifierMembershipWitness(
		a_addr_1_nullifier
	);
	...
	const a_addr_0_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		a_addr_0_nullifier
	);
	const a_addr_1_updated_nullifier_NonMembership_witness = getupdatedNullifierPaths(
		a_addr_1_nullifier
	);

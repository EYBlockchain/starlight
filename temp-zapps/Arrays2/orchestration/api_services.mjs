...
export async function service_add(req, res, next) {
	...
	try {
		...
		const b_index_1_newOwnerPublicKey =
			req.body.b_index_1_newOwnerPublicKey || 0;
		const b_index_2_newOwnerPublicKey =
			req.body.b_index_2_newOwnerPublicKey || 0;
		const b_index_3_newOwnerPublicKey =
			req.body.b_index_3_newOwnerPublicKey || 0;
		const b_index_4_newOwnerPublicKey =
			req.body.b_index_4_newOwnerPublicKey || 0;

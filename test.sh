...
do
    ...
    #docker run -v $PWD:/app/code --name testcircuits2 -ti zokrates/zokrates:0.8.8 zokrates compile -i /app/code$zokelement --r1cs /app/code/out.r1cs || echo “$(tput setaf 1) $zokelement failed”
    docker run -v $PWD:/app/code --name testcircuits2 -ti zokrates/zokrates:0.8.8 zokrates compile -i /app/code$zokelement --output /app/code/out  || echo “$(tput setaf 1) $zokelement failed”
    docker rm testcircuits2
done
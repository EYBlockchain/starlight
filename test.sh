...
do
    ...
    docker run -v $PWD:/app/code --name testcircuits -ti ghcr.io/eyblockchain/zokrates-worker-m1:v1.1 ./zokrates compile -i code$zokelement || echo “$(tput setaf 1) $zokelement failed”
